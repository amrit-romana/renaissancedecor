    ...
    <section className="w-full bg-[var(--color-parchment)] pb-24 flex flex-col items-center">
      <div className="w-full max-w-[1300px] mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mb-24">
        ...
        <div className="w-full h-full flex flex-col items-center justify-center p-10 md:p-16 bg-[var(--color-parchment)] aspect-[4/5]">
          ...
          >
            <span className="font-serif text-4xl text-[#3A2A1F] leading-none mb-2">“</span>
            <p className="font-sans text-lg md:text-xl text-[#3A2A1F] leading-relaxed font-medium">
              Adam applies her keen eye for design to creating quietly joyful and glamorous yet welcoming interiors
            </p>
            <span className="font-sans text-[9px] uppercase tracking-[0.25em] text-[#3A2A1F]/80 font-bold mt-4">
              House and Garden
            </span>
          </motion.div>
        </div>
